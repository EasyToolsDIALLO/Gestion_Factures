...
public class NonPayeeFragment extends Fragment implements FactureRecyclerAdapter.OnListItemClick{

    List<Facture> factureList;
    public NonPayeeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_non_payee, container, false);
        factureList = Intermediaire.getFactureList();

        RecyclerView recyclerView  = root.findViewById(R.id.recyclerNonPayee);
